   ...
   /**
    ...
    public static function getAll($limit = 10, $offset = 0, $filter = array())
    {
       ...
       $query = 'SELECT i.id, i.image, co.name, co.url, co.description
        ...
        $detailUrl = Navigation::getURLForBlock('Vacancies', 'Detail');
    ...
    public static function getNavigation($id)
    {
        ...
        // init var
        $navigation = array();
        $detailLink = Navigation::getURLForBlock('Vacancies', 'Detail') . '/';
    ...
    public static function search(array $ids)
    {
        ...
        // prepare items for search
        $detailUrl = FrontendNavigation::getURLForBlock('Vacancies', 'Detail');
        foreach ($items as &$item) {
            $item['full_url'] = $detailUrl . '/' . $item['url'];
        }
