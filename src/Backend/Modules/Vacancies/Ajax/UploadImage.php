    ...
    private function upload($file)
    {
        ...
        if ($file_data) {
            ...
            if (filesize($temp_file) > 0) {
                ...
                $insert['vacancy_id'] = $this->id;
                $insert['data'] = serialize(array());

                $insert['sequence'] = BackendVacanciesImagesModel::getMaximumSequence($this->id) + 1;
                $insert['hidden'] = 'N';

                //BackendVacanciesHelper::generateThumbnail($filename, $files_path, $preview_files_path);
                ...
                $insert['id'] = BackendVacanciesImagesModel::insert($insert);
                ...
                foreach ($this->languages as $language) {
                 ...
                 // insert it
               BackendVacanciesImagesModel::insertContent($content);
