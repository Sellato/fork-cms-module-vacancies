...
/**
 * This is the settings-action, it will display a form to set general Vacancies settings
 *
...
class Settings extends BackendBaseActionEdit
{
    ...
    private function loadForm()
    {
     ...
     $this->frm->addCheckbox(
        'make_widget_per_vacancy',
        $this->get('fork.settings')->get($this->getModule(), 'make_widget_per_vacancy', false)
    );
    $this->frm->addCheckbox(
        'allow_tags',
        ...
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                $this->get('fork.settings')->set(
                    $this->getModule(),
                    'make_widget_per_vacancy',
                    (bool) $this->frm->getField('make_widget_per_vacancy')->getValue()
                );
